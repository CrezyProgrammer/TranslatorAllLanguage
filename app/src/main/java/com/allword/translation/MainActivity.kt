...
open class MainActivity() : AppCompatActivity(), OnCountryPickerListener {
 ...
 private val TAG: String? = MainActivity::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startService(intent)
s2t.setOnClickListener {         promptSpeechInput()
}
        ...
        bookmark.setOnClickListener {
            if ((textToTranslate!!.text.toString().trim { it <= ' ' } == "")) Toast.makeText(this, "Please Write Something", Toast.LENGTH_SHORT).show()
            else {
  ...
  */
      if(ClipboardMonitorService.Text.isNotEmpty())
        textToTranslate.setText(ClipboardMonitorService.Text)
            ...
            override fun doInBackground(vararg params: Void?): String? {
                ...
                try {
                    ...
                    val translation: Translation = translate.translate(text ,
                            Translate.TranslateOption.sourceLanguage(lan1code?.trim()),
                            Translate.TranslateOption.targetLanguage(lan2code?.trim()))

                    Log.i("123321","340:"+translation.translatedText)

                    return translation.translatedText
                } catch (e: Exception) {
                     Log.i("123321","355:"+e.message)
                    return ""
                }
            }
...
//        }
    ...
    private fun promptSpeechInput() {
        ...
        try {
            Log.i("123321","starting activity result")
            startActivityForResult(intent, REQ_CODE_SPEECH_INPUT)
        } catch (a: ActivityNotFoundException) {
            Log.i("123321","465:"+a.message)
...
Log.i("123321","428:"+requestCode)
    ...
    inner class LableDetectionTask(activity: MainActivity, annotate: Annotate) : AsyncTask<Any?, Void?, String>() {
    ...
    open fun nextStep(file: String) {
        val intent = Intent(this@MainActivity, CropAndRotate::class.java)
