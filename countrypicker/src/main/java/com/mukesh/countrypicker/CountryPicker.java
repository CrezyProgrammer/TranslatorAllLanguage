...
public class CountryPicker implements BottomSheetInteractionListener, LifecycleObserver {
  ...
  private final Country[] COUNTRIES = {
      ...
      new Country("AM", "Amharic", "+374", R.drawable.flag_am, "AMD"),
      ...
      new Country("bn", "Bangla", "+880", R.drawable.flag_bd, "BDT"),
      ...
      new Country("GA", "Gabon", "+241", R.drawable.flag_ga, "XAF"),
          new Country("en", "English", "+44", R.drawable.flag_gb, "GBP"),
      ...
      new Country("hi", "Hindi", "+91", R.drawable.flag_in, "INR"),
